...
Design, review or improve an AI agent Skill, or turn a repeatable workflow into a SKILL.md package. Not for executing the underlying workflow or generating a visual design language.
...
```text
Review this SKILL.md trigger and evaluation design.
```
...
```sh
npx skills add sunny0826/open-source-skills --skill skill-architect
```
